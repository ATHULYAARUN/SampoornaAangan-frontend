...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Beautiful Pink and White palette
        primary: {
          50: '#fdf2f8',
          100: '#fce7f3',
          200: '#fbcfe8',
      ...
      fontFamily: {
        ...
        fun: ['Comic Neue', 'cursive'], // Child-friendly font
      },
      animation: {
        ...
        "background-move": "backgroundMove 20s ease-in-out infinite",
      },
      keyframes: {
        bounceGentle: {
        ...
        textGlow: {
          "0%": { textShadow: "0 0 5px rgba(249, 115, 22, 0.5)" },
      ...
      boxShadow: {
        ...
        'colorful': '0 10px 15px -3px rgba(59, 130, 246, 0.1), 0 4px 6px -2px rgba(59, 130, 246, 0.05)',
      }
    },
  },
  plugins: [],
